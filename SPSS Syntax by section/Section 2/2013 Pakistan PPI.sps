...
*Pakistan PPI.
weight off.
recode dl11 (1=0) (2=9) (3=11) (4=12) into province.
...
recode dl15 (1=0) (2=4) (3=6) into edu.
recode dl16 (1=0) (2=3) into water.
recode dl17 (1=0) (2=2) (3=4) into toilet.
recode dl18 (2=0) (1=12) into refridgerator.
recode dl19 (2=0) (1=3) into tv.
recode dl20 (2=0) (1=12) into vehicle.

compute ppi_score = (province + young + school + occupation + edu + water + toilet + refridgerator + tv + vehicle).
freq ppi_score.
...
*Mean = 54.2, meaning 54.2% of our survey are below the $2.50/day poverty line.  This means the cutoff is a ppi score of 61: Those with a score of 61 or lower
are below the poverty line, those with a ppi score of more than 61 are aboev the poverty line.

recode ppi_score (0 thru 61 = 1) (62 thru 100 = 0) into POVERTY1.
