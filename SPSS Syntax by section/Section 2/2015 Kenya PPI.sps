...
weight off.
compute ppi_score = 0.
recode dl14 (9 thru highest = 0) (7 thru 8 = 5) (6 = 8) (5 = 12) (4 = 18) (3 = 22) (1,2 = 32) into hh_members.
variable labels hh_members 'hh_members'.
recode dl15 (1=0) (2=1) (3=2) (4=6) (5=6) (6=11) into female_school.
variable labels female_school 'female_school'.
recode dl16 (1=0) (2=3) (3=7) (4=9) into male_job.
variable labels male_job 'male_job'.
recode dl17 (1=0) (2=2) (3=5) (4=8) into hh_rooms.
variable labels hh_rooms 'hh_rooms'.
recode dl18 (1=0) (2=3) into hh_floor.
variable labels hh_floor 'hh_floor'.
recode dl19 (1=0) (2=6) (3=12) into light_source.
variable labels light_source 'light_source'.
recode dl20 (1=0) (2=4) into own_iron_2.
variable labels own_iron_2 'own_iron_2'.
recode dl21 (1=0) (2=2) (3=4) into mosq_nets.
variable labels mosq_nets 'mosq_nets'.
recode dl22 (1=0) (2=6) (3=10) into own_towels.
variable labels own_towels 'own_towels'.
recode dl23 (1=0) (2=3) (3=7) into own_pan.
variable labels own_pan 'own_pan'.
compute ppi_score = (hh_members + female_school + male_job + 
hh_rooms + hh_floor + light_source + own_iron_2 + mosq_nets + own_towels + own_pan).
freq ppi_score.
...
recode ppi_score (0 thru 54 = 1) (55 thru 100 = 0) into POVERTY1.
...
*mean of ppi_prob_125 is 22.482599.
