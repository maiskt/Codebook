...
weight off.
recode dl14 (1=0) (2=9) (3=11) (4 thru 5=12) into province.
recode dl15 (1=0) (2=6) (3=11) (4=15) (5=22) (6=31) into young.
recode dl16 (1=0) (2=5) into school.
recode dl17 (1=0) (2=5) (3=12) into occupation.
recode dl18 (1=0) (2=4) (3=6) into education.
recode dl19 (1=0) (2=3) into water.
recode dl20 (1=0) (2=2) (3=4) into toilet.
recode dl21 (1=0) (2=12) into refridgerator.
recode dl22 (1=0) (2=3) into tv.
recode dl23 (1=0) (2=12) into vehicle.
...
*Mean = 50.44, meaning 50.44% of our survey are below the $2.50/day poverty line.  This means the cutoff is a ppi score of 64: Those with a score of 64 or lower
are below the poverty line, those with a ppi score of more than 64 are aboev the poverty line.

recode ppi_score (0 thru 64 = 1) (65 thru 100 = 0) into POVERTY1.
...
DES ppi_prob2.
*mean of ppi_prob2 is 7.414400.
recode ppi_score(0 thru 34=1)(35 thru highest=0) into ppi_cutoff2.
